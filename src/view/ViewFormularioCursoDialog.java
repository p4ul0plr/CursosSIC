 ...
 * @author paulo
 */
public class ViewFormularioCursoDialog extends javax.swing.JDialog {

    /**
     * Creates new form viewFormularioCurso
     */
    public ViewFormularioCursoDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewFormularioCursoDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewFormularioCursoDialog dialog = new ViewFormularioCursoDialog(new javax.swing.JFrame(), true);
